                ...
                <tr>
                    <th>
                        <p style="align-content: center;">
                            <h1 style="color:">Highest Average Ranking</h1>
                        </p>
                    </th>
                </tr>
                <tr>
                    ...
                    <table align="center" width="100%">
                            ...
                            $query = "SELECT playername,avg,team.name,rnk FROM team , (SELECT playername,avg,player.team_id, @rank := CASE WHEN @rankval = avg THEN @rank WHEN (@rankval := avg) IS NOT NULL THEN @rank + 1 END AS rnk FROM player, (SELECT @rank := 0, @rankval :=NULL) as x ORDER BY avg DESC) as p1 WHERE p1.team_id=team.team_id";                            $result = mysqli_query($con, $query);
