                ...
                <tr>
                    <th>
                        <p style="align-content: center;">
                            <h1 style="color:">Most 6s Ranking</h1>
                        </p>
                    </th>
                </tr>
                <tr>
                    <th>
                        <table align="center" width="100%">
                            ...
                            $query = "SELECT playername,6s,team.name,rnk FROM team , (SELECT playername,6s,player.team_id, @rank := CASE WHEN @rankval = 6s THEN @rank WHEN (@rankval := 6s) IS NOT NULL THEN @rank + 1 END AS rnk FROM player, (SELECT @rank := 0, @rankval :=NULL) as x ORDER BY 6s DESC) as p1 WHERE p1.team_id=team.team_id";                            $result = mysqli_query($con, $query);
